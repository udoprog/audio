...
pub type pa_context_string_cb_t = ::std::option::Option<
    unsafe extern "C" fn(
        c: *mut pa_context,
        success: ::std::os::raw::c_int,
...
>;
unsafe extern "C" {
    pub fn pa_context_send_message_to_object(
        c: *mut pa_context,
        recipient_name: *const ::std::os::raw::c_char,
        message: *const ::std::os::raw::c_char,
        message_parameters: *const ::std::os::raw::c_char,
